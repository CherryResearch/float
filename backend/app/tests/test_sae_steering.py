...
from app.sae.model import make_identity_sae
from app.sae.steer import apply_steering_to_hidden
from app.sae.types import SteeringConfig
...
def test_apply_steering_dry_run_keeps_hidden_unchanged():
    ...
    config = SteeringConfig(
        features={0: -0.3}, layer=3, token_positions="all", dry_run=True
    )
