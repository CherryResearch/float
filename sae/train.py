...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--activations", required=True, help="Activation record input path.")
    parser.add_argument("--out", required=True, help="Output SAE weights JSON path.")
    parser.add_argument("--features", type=int, default=256, help="Number of SAE features.")
